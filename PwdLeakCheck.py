#You will not be able to run this file directly and copy it onto your computer and run it on your machine (We take inputs from the cmd, *can also do some modifications to take inputs directly.)
